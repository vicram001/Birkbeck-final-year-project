...
class TextClassifier:
    ...
    def batch_predict(self, texts, top_k=None, return_scores=True, plot_heatmap=False):
        return [self.predict(t, top_k=top_k, return_scores=return_scores, plot_heatmap=plot_heatmap) for t in texts]
